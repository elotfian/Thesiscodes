...
beta=3; %=4;    % Leader Selection Pressure Parameter
gamma=4;    % Extra (to be deleted) Repository Member Selection Pressure
...
for i=1:GreyWolves_num
    ...
    GreyWolves(i).Position=Position(xmax,ymax,lbc2,nvar);
    GreyWolves(i).Cost=MyCost(GreyWolves(i).Position,samplev,aa,C0,nu)';   
